...
const MAX_TICK_MOVE_SHARE = 0.12; // Was 0.26
const MIN_MAX_TICK_MOVE_PCT = 0.003; // Was 0.012;

const INVENTORY_PRESSURE_BASE = 0.0025; // Was 0.004
const INVENTORY_PRESSURE_INTENSE = 0.0045; // Was 0.006
const ORDER_FLOW_PRESSURE_BASE = 0.003; // Was 0.006
