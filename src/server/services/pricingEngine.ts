...
const MIN_IDLE_MOVE_PCT = 0.0025;
const RANDOM_MOVE_SHARE = 0.16;
const SOFT_MEAN_REVERSION = 0.015;
const HARD_MEAN_REVERSION = 0.04;
const HARD_REVERSION_DRIFT = 0.12;
const MAX_TICK_MOVE_SHARE = 0.26;
const MIN_MAX_TICK_MOVE_PCT = 0.012;

const INVENTORY_PRESSURE_BASE = 0.004;
const INVENTORY_PRESSURE_INTENSE = 0.006;
const ORDER_FLOW_PRESSURE_BASE = 0.006;
const ORDER_FLOW_PRESSURE_INTENSE = 0.01;

const BASE_TRADE_IMPACT_PCT = 0.002;
const SIZE_TRADE_IMPACT_MULTIPLIER = 0.12;
const SCARCITY_TRADE_IMPACT_MULTIPLIER = 1.5;
const MAX_TRADE_IMPACT_PCT = 0.03;
